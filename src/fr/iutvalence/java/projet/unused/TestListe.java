...
public class TestListe
{
	...
	public static void main(String[] args)
	{
		...
		/**** 2nd methode ****/
		/*  
		T.setObjet(new Movable(position,taille));
		A = T.setSuivant();
		...
		A = T;
		((Movable) A.getObjet()).move(10,10);
		A = A.suivant();
		((Movable) A.getObjet()).move(20,20);
		A = A.suivant();
		((Movable) A.getObjet()).move(30,30);
		
		
		A = T;
		E1 = ((Movable) A.getObjet());
		A = A.suivant();
		E2 = ((Movable) A.getObjet());
		A = A.suivant();
		E3 = ((Movable) A.getObjet());
		*/
