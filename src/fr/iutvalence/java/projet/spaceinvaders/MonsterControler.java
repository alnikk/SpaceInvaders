...
/**
 * This interface defines all common 
 * method to control Monsters.<br/>
...
public interface MonsterControler
{
	 ...
	 * @return (integer) This returns the wait 
	 * 			time between each move. When it's 
	 * 			equals to 0
	...
	/**
	 * This method wait a time in function of 
	 * sleepTime an difficulty value and of monster 
	 * alive's number
	 */
