 ...
 * @author Gallet Guyon
 */
public class SpaceInvadersMaVs extends SpaceInvaders implements TankControler, MonsterControler
{
	// ************************** Constructors **************************//
	/**
	 ...
	 */
	public SpaceInvadersMaVs(String name, Score score, Display d)
	{
		super(name, score, d);
	}
	 ...
	 * @param d The display object to use.
	 */
	public SpaceInvadersMaVs(String name, Score score, int nbMonsters, int nbTanks, Display d)
	{
	 ...
	 * @param d The display object to use.
	 */
	public SpaceInvadersMaVs(String name, Score score, int nbMonsters, int nbTanks, Coordinates max, Display d)
	{
	 ...
	 * @param d The display object to use.
	 */
	public SpaceInvadersMaVs(String name, Score score, int nbMonsters, int nbTanks, Coordinates max, int sleepTime, Display d)
	{
	 ...
	 * @param d The display object to use.
	 */
	public SpaceInvadersMaVs(String name, Score score, int nbMonsters, int nbTanks, Coordinates max, int sleepTime, int acceleration, Display d)
	{
